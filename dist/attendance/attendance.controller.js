...
let AttendanceController = class AttendanceController {
    ...
    update(id, checkOutData) {
        return this.attendanceService.checkOut(+id, checkOutData);
    }
    findOne(id) {
        return this.attendanceService.findOne(+id);
    }
    findOneHistory(id, page, limit) {
        return this.attendanceService.attendanceHistory(+id, page, limit);
    }
};
...
__decorate([
    (0, common_1.Get)('attendanceHistory/:id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", void 0)
], AttendanceController.prototype, "findOneHistory", null);
